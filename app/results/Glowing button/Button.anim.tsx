...
// Define the Variants type explicitly since we're having issues with imports
type Variants = {
  [key: string]: any
}
...
// Export all required animations explicitly
...
// Add a default export as well to ensure the module is properly recognized
export default {
  buttonAnim,
  labelAnim,
  svgAnim,
