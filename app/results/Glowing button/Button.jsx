...
import { buttonAnim, highlightContainerAnim, highlightAnim, labelAnim } from "./animations.js"
...
const Button = ({ children = "Button Text", hueValue = 0, className = "", onClick, ...rest }) => {
    ...
    <div style={{ position: "relative" }}>
      ...
      >
        <motion.div
          ...
          animate={hover ? "anim" : "init"}
        >
          <motion.div variants={highlightAnim} className="highlight"></motion.div>
        </motion.div>
        <Stars hover={hover} />
