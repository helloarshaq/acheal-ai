  ...
  return (
    <div className={`min-h-screen bg-[#EEEBE7] ${aeonikPro.variable}`}>
      <div className="flex items-center justify-center p-4 min-h-screen">
        <div className="w-full max-w-[1380px] flex rounded-[30px] overflow-hidden bg-white shadow-lg">
          {/* Left side - Image */}
          <motion.div
          ...
          <div className="w-1/2 p-12 bg-[#E5E1DB]">
            {/* Logo in the middle with gradient */}
            ...
            <div className="h-full flex flex-col">
              ...
              {/* Disclaimer */}
              <div className="text-xs text-[#6A6A6A] mt-8 text-right">
...
function NameStep({ name, setName }: { name: string; setName: (name: string) => void }) {
  return (
    <div>
      <h1 className="text-3xl md:text-4xl font-light mb-4">What is your Name?</h1>
...
// Confirm step - Updated to remove Next button and add direct actions
function ConfirmStep({
  ...
  return (
    <div>
      <h1 className="text-3xl md:text-4xl font-light mb-4">Are you sure about this image?</h1>
...
function AgeStep({ age, setAge }: { age: string; setAge: (age: string) => void }) {
  ...
  return (
    <div>
      <h1 className="text-3xl md:text-4xl font-light mb-4">What is your Age?</h1>
